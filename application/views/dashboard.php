			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="<?php echo base_url();?>index.php"><i class="icon-home"></i><span class="hidden-tablet"> Dashboard</span></a></li>
						<li><a class="ajax-link" href="<?php echo base_url();?>index.php/sales"><i class="icon-shopping-cart"></i><span class="hidden-tablet"> Sales</span></a></li>
						<li><a class="ajax-link" href="<?php echo base_url();?>index.php/warehouse"><i class="icon-folder-close"></i><span class="hidden-tablet"> Warehouse</span></a></li>
						<li><a class="ajax-link" href="<?php echo base_url();?>index.php/accounting"><i class="icon-list-alt"></i><span class="hidden-tablet"> Accounting</span></a></li>
