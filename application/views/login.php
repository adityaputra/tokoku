...
<head>
	<!--
		Tokoku v0.1
		Copyright 2012 Aditya Putra
		Licensed under the Apache License v2.0
		http://www.apache.org/licenses/LICENSE-2.0
		
		http://adityaputra.com
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="well span5 center login-box">
					...
					<form class="form-horizontal" action="index.php/login/dologin" method="post">
						<fieldset>
							...
							<div class="input-prepend" title="Password" data-rel="tooltip">
								<span class="add-on"><i class="icon-lock"></i></span><input class="input-large span10" name="password" id="password" type="password" value="admintokoku" />
							</div>
							<div class="clearfix"></div>
